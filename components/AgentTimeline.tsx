      ...
      {hasUsageData && (
        ...
        >
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            <span>🪙</span>
            <span>Total: <strong style={{ color: '#047857' }}>{fmtTokens(summaryTotalTokens)}</strong> tokens</span>
          </span>
          <span style={{ color: '#a7f3d0' }}>·</span>
          <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px' }}>
            <span>💰</span>
            <span>Cost: <strong style={{ color: '#047857' }}>{fmtCost(summaryCost)}</strong></span>
          </span>
          <span style={{ color: '#a7f3d0' }}>·</span>
          <span>{summaryAgents} agents</span>
          {summaryDuration > 0 && (
            <>
              <span style={{ color: '#a7f3d0' }}>·</span>
              <span>⚡ {fmtDuration(summaryDuration)}</span>
            </>
          )}
        </div>
      )}
                      ...
                      {usage && (
                        <div style={{ marginTop: '6px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          <span style={{ fontSize: '11px', color: '#64748b', fontWeight: 600, whiteSpace: 'nowrap' }}>
                            {fmtTokens(usage.totalTokens)} tok · {fmtCost(usage.costUsd)}
                          </span>
                        </div>
                      )}
                    </div>
